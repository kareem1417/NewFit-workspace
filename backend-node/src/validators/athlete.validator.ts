...
export const upsertMetricsValidation: ValidationChain[] = [
  ...
  body("goal")
    ...
    .isIn(Object.values(user_goal_enum))
  ...
  body("speed_score")
    ...
    .isInt({ min: 1, max: 10 })
    .withMessage("Score must be between 1 and 10."),
  body("flexibility_score")
    .optional()
    .isInt({ min: 1, max: 10 })
    .withMessage("Score must be between 1 and 10."),
  body("explosiveness_score")
    .optional()
    .isInt({ min: 1, max: 10 })
    .withMessage("Score must be between 1 and 10."),
  body("recovery_score")
...
export const createSnapshotValidation: ValidationChain[] = [
  ...
  body("snapshot_type")
    .optional()
    .isIn(Object.values(snapshot_type))
    .withMessage("Invalid snapshot type."),
  body("program_enrollment_id")
    .optional()
    .isUUID()
